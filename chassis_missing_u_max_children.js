// find models that might be a chassis and do not have u_max_children
...
// find sleds that have a parent that is one of these models
// collect the unique sys_id of the parent chassis
